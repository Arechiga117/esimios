    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                <a href="../iniciar.php" class="btn btn-primary py-2 px-4 d-none d-lg-block">Iniciar Sesion</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
    ...
    <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="aforma bg-dark">
            <div id="login">
                <h1>Editar Alumno</h1>
                <p><?php ?></p><br>
                <form action="editando.php?class=alumno_e" method="post">
                    <div style="display: none;">
                        <input name="id" autocomplete="off" value="<?php echo ($alumno[0]["ID"]); ?>"/>
                    </div>
                    <div class="field-wrap">
                        <label>
                            Nombre<span class="req">*</span>
                        </label>
                        <input name="nombre" autocomplete="off" value="<?php echo ($alumno[0]["Nombre"]); ?>"/>
                    </div>
                    <div class="field-wrap">
                        <label>
                            Apellido paterno<span class="req">*</span>
                        </label>
                        <input name="A_paterno" autocomplete="off" value="<?php echo ($alumno[0]["A_paterno"]); ?>"/>
                    </div>
                    <div class="field-wrap">
                        <label>
                            Apellido materno<span class="req">*</span>
                        </label>
                        <input name="A_materno" autocomplete="off" value="<?php echo ($alumno[0]["A_materno"]); ?>"/>
                    </div>
                    <div class="field-wrap">
                        <label>
                        ...
                        <select name="Plan_id">
                            <?php
                                foreach ($grados as $a => $grado) {
                                    echo "<option value='" . $grado["ID"] . "'". (($grado["ID"]==$alumno[0]["Plan_id"])? 'selected': '') . ">" . $grado["Grado"] . "</option>";
                                }
                            ?>
                        </select>

...
<body>
    ...
    <div class="jumbotron jumbotron-fluid position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="aforma bg-dark">
            <div id="login">
            <h1>Inscribir un nuevo Alumno</h1>
                <p><?php ?></p><br>
                <form action="creando.php?class=alumno_c" method="post">
                    ...
                    <div class="field-wrap">
                        ...
                        <input name="A_paterno" autocomplete="off"/>
                    </div>
                    <div class="field-wrap">
                        <label>
                            Apellido materno<span class="req">*</span>
                        </label>
                        <input name="A_materno" autocomplete="off"/>
                    </div>
                    <div class="field-wrap">
                        <label>
